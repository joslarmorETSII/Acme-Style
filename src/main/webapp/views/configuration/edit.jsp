...
<div class="container">
	<div class="row">
		<div class="col-md-10">
			...
			<form:form action="configuration/administrator/edit.do" modelAttribute="configuration" class="form-horizontal">

				<form:hidden path="id"/>
				<form:hidden path="version"/>

				<form:label path="englishWelcome"><spring:message code="configuration.englishWelcome"/></form:label>
				<form:input class="form-control" path="englishWelcome"/>
				...
				<form:textarea class="form-control" path="spanishWelcome"/>
				...
				<form:textarea class="form-control" path="tabooWords" />
				...
				<form:textarea class="form-control" path="photos" />
