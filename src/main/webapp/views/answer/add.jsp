...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form:form action="answer/artist/edit.do" modelAttribute="answer" class="form-horizontal" >
                <form:hidden path="id" />
                ...
                <div class="form-group last">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <acme:cancel url="/answer/actor/list.do?questionId=${answer.question.id}" code="general.cancel"/>
                    </div>
                </div>
